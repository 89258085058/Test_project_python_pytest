...
def test_add_contact(app):
    ...
    app.manager.modification_personal_information(Contact(firstname="software", middlename="software", lastname="software", nickname="software", title="software", company="software",
